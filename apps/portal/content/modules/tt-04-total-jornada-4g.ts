...
export const module_tt_04_total_jornada_4g: ModuleContentFull = {
  ...
  shortDescription: "Módulo sobre Total Jornada 4G da Total Track.",
  durationMinutes: 30,
  academy: "totaltrack",
  status: "ready",
  category: "Geral",
      ...
      blocks: [
        {
          type: "text",
          paragraphs: [
            ["O ", { term: "Total Jornada 4G" }, " é uma solução desenvolvida pela Total Track para otimizar operações."],
          ],
        },
      ],
    }
